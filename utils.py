...
CURRENT_YEAR = os.environ.get('CURRENT_YEAR', '2024-2025')
...
def calc_subject_annual(student_id, subject_code, school_year, class_id=None):
    """
...
def calc_general_average(student_id, school_year, class_id):
    ...
    for code, _ in SUBJECTS:
        annual = calc_subject_annual(student_id, code, school_year, class_id)
